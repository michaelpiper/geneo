...
<section class="home-about-area pt-10">
    <div class=" wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <div class="mx-5">
            <?= $this->Flash->render() ?>
            <img class="img-fluid img-preview" onclick="$('#picture').click()" style="max-height:300px;height:300px;" src="<?= isset($category->cover_image) ? $category->cover_image:'/img/placeholder.png' ?>" alt="">
